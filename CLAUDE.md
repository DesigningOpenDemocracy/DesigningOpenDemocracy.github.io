...
pushed direct to main if they meet all of the following:

1. File: `docs/heartbeat/posts/YYYY-MM-sync.md` (or `YYYY-MM-DD-sync.md` for
   mid-month runs).
...
5. A human must review and merge before it lands on main (see Push permissions
   in `HEARTBEAT.md` for the direct-push vs. PR mechanics).
