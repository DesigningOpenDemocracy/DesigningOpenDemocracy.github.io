Podcast transcripts for Designing Open Democracy events.

The 2017-2022 transcripts were downloaded from https://www.pod-transcript.com/podcast/1492656241
(automated transcripts - verify quotes against the recording before citing).

Filename convention: <event-date>_<original name>.<srt|txt|vtt>
The date prefix is the date the event/conversation was RECORDED, which often
differs from the matching blog post's `date:` (usually the publish date).
Where the date came from:
  ...
  2017-08-21  2017-08-21-podcast.md (parts 1-3)            meetup date in post heading
