...
This matters because the tests apply to any system, including liberal democratic ones. A government that invokes democratic values and international law selectively — supporting allied nations' actions it would condemn in adversaries — is running the hypocrisy disqualifier against its own stated position. A system that allows concentrated wealth to capture its electoral processes is failing on structural accountability. The use of democratic language to legitimise selective standards is not a feature exclusive to any one type of system — and the consistent application of scrutiny across all of them is what makes this disposition trustworthy rather than just convenient.
