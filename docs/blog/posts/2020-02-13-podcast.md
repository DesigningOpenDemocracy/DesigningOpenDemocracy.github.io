...
Ben Ballingall is a representative of Flux Party's Victorian branch. This conversation with Brian Khuu was recorded on 11 February 2020, ten days before DOD's [2020 Primer](2022-02-24-podcast.md), and the same day as a chance encounter at Federation Square with a British expat who had left the UK over Brexit — which became the opening frame for the whole discussion.
...
The conversation starts from a concrete failure case: the Brexit referendum. Just before recording, Ben had met a British expat who described leaving the UK after the result. What struck Ben wasn't that the public got it wrong — it was the design of the question. Who wrote it? Why did it take two years to implement? Brian adds that after the vote, the biggest Google search in the UK was *"what is the EU?"* That, Ben agrees, is not a failure of the people — it's a failure of the instrument.

> "Is it a true representation of democracy when the people who voted and took part in the vote didn't have a clue or didn't even really care or didn't even really know what they were voting on?"
> — Ben Ballingall (probably; the transcript has no speaker labels, and the turn could be Brian's)
...
Brian asks directly: DOD had [Nicholas Gruen present on citizen juries in 2017](2017-10-21-podcast.md) — Gruen's goal was "the well-considered opinion of the population." Why didn't Flux go that route?
...
> "We don't want to try and create these representatives that are really great at most things, or jack of all trades at most things, when we could have masters at everything, delivering the results that are … confirmed by the people."
> — Ben Ballingall
...
> "You can't destroy money wanting to affect politics, but you can make a system where it's stupidly expensive to try and lie, and you have to be transparent to the people."
> — Ben Ballingall

His example was Clive Palmer's heavy 2019 advertising spend. Under IBDD, a campaign like that would have to argue why people should vote yes on a specific issue, and it would be competing with, in Ben's words, "Dave on his couch" who "just did a live video on YouTube for free, and it explained why I should vote no."

## What if a Flux MP defects?

Brian pushes on the weak point: what stops a Flux MP ignoring the app once elected? Ben concedes an MP's freedom to vote as they like is normally "actually a really nice thing", since it stops a party making them "sign this contract that says you'll vote how I tell you". For Flux it is a vulnerability. But a defector is "not able to ever come back": a party-hopper can claim the party has changed, while a Flux MP who defects is saying, in effect, "I believe I'm smarter than the people". Brian reframes defection as "I no longer believe in the system". Ben's verdict: "it would look shit… But it wouldn't kill flux. It wouldn't kill the idea of being represented by the community voting."
