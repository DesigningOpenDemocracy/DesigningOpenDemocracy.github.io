...
> "The power that corporations have in politics is obviously one of the biggest issues, I think, is facing democracy today… I can't really see corporations losing power anytime in the near future without some sort of drastic change in politics."
> — Tom Sesselman
...
> "I have faith in humanity, and I think that we can be smarter enough to start creating a social change now that can allow us to create a certain truth that basically is what John Lennon was saying, power to the people."
> — Francisco
...
> "Social media websites like Reddit, or through experimental argument mapping websites… may, if it encompasses with, or joined with other kind of technologies which allows us to vote… might allow us to actually have a full, or at least better control over the kind of people we filter into our position of power, or the decision making that filters into law."
> — Brian
...
**Andrew Downing** — listed in the meeting notes as a "Councillor in the pirate party" (most likely a member of Pirate Party Australia's National Council rather than an elected local councillor) — names **trust** as the big one, and argues that much of the rest follows from it:

> "Trust is a big one. Discourse between opposing sides, public forums, that sort of thing. A lot of the rest of all can sort it itself out if you just deal with those ones… Either people cooperate, they cooperate based on trust. So that's just fundamental."
> — Andrew Downing
...
> "I don't like describing it as trustless. Trust is still involved. It's just, it's a distributed trust mechanism rather than a centralized one… In a centralized institution, it can become corrupt and then you can't trust it anymore. Instead, the distributed trust systems mean that, well, either everybody collectively has a common interest and you can trust in that, or if you can't trust in that, well, you're there anyway."
> — Andrew Downing
...
The recording closes with a participant (most likely **Kevin Woods**, returning to the "desired future" question he'd raised earlier and which Nick had deferred for time — though David, whose constitutional framing it also echoes, can't be ruled out from the recording) tying the threads together: despite the different framings, everyone at the table is ultimately describing the same goal — equality, fairness, and, in their words, "just... being human."
...
> "Bring the government, governance, the whole governance of the whole system back into the communities to have, for the first time, full self-governing communities."
...
Read back now, the most striking thing about the round is what's missing: **nobody named elections or voting systems as the problem.** Every answer is about power (corporations, populists), information (misinformation, overload) or human nature (trust, bias, the commons). The mechanism-design focus of DOD's later episodes — Flux's issue-based voting, MiVote's four-option votes, Nicholas Gruen's citizens' juries — came afterwards.

Two answers also turn out to be the same argument from opposite ends, from people sitting side by side: Andrew's "trust is fundamental" and Nick's "competition pulls us away from cooperation." DOD's [2019 Trust episode](2019-12-11-podcast.md) is, in effect, that conversation at full length.

And Kevin's deferred question — "How about we work on a desired future of how you envision a democracy?" — was never answered that night. Arguably the rest of DOD's archive is the attempt.

## Detailed notes

A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2017-05-19_challenges-facing-democracy.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
