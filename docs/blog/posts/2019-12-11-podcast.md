...
This was the first episode recorded for the DOD podcast (its intro calls it "the first of a two-part series on Trust"; no second part was released) — an unusually wide-ranging conversation that starts from "what is trust?" and ends up explaining why democracy-reform groups keep failing to cooperate with each other.
...
> "It's a bigger tribe, and we agreed on the rules. And yeah, the bigger it gets, the more rules you get."
...
> "How can we, without needing to identify as one thing, even though there are different approaches, find one thing that brings all of us, in this case, together, and act as one entity and still be effective. Why not needing to compromise on any of your values? To me, that's the huge challenge."
> — Alexar Pendashteh
...
The final third traces trust through money: gold- and silver-backed notes ("I trust that you would defend my right to claim to gold") → fiat currency ("trust the government") → hyperinflation (Weimar Germany, Zimbabwe) when that trust collapses. Then Bitcoin, which the group reads as a philosophical experiment: trust **relegated from a human institution to mathematics**, producing a "trustless" system where consensus needs no central authority. Alexar's observation is the keeper — blockchain shifted IT's focus *from what we do with information to who does what with information*, i.e. from data to **governance** and verifiable claims. He dates it as the moment technologists and social reformers found common ground.
...
> "Who is influenced is not who is influencing it… this disconnect is the root cause of issues, which is something like cooperatives would solve… When you close this loop, if someone is influencing something, they also need to be influenced the same degree… In engineering, that's called feedback loop."
> — Alexar Pendashteh

(Someone else in the room supplies the word for what happens without one: "de-stabilize".)
...
## Why farmer co-ops fail, and a ledger that helped

One thread the conversation keeps circling is why co-operatives — in theory "a perfect match" for farmers squeezed by supermarket buyers — so often fail in practice. The group's answer is the prisoner's dilemma again. Antony McMullen puts it plainly: in a co-op "you'll have winners and losers living in that group, and you've got to feel comfortable with losing short term, having a long term gain for everyone. That doesn't really sit well with the rest of our economy." Get burned a few times, as someone else in the room adds, and "trust goes away and everything falls apart."

Alexar's counter-example is a Brisbane-founded startup that gave farmer co-ops phones running a shared ledger, so members could see that what was agreed was recorded and settled: "I don't necessarily need to trust you, basically I need to trust the system." He relays the founders' claim that some coffee farmers in Kenya tripled their income. (The startup isn't named on the recording, and the figure is theirs as he relayed it.) His conclusion — "in theory the system was correct, but the human element was kind of breaking the system. And an intervention of technology allowed for humans to reestablish trust" — is met straight away by Andrew Kay's caution: trust, but verify.

## Detailed notes

A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2019-12-11_trust-concept-analysis.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
