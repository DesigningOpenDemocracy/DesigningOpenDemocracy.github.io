...
He estimated "maybe two million to run a citizen assembly for six months to a year". Asked whether to start smaller, he refused: "That is the opiate of activists everywhere." He calls it "radical incrementalism": one body with a different institutional logic, dropped in "like a bit of ink in a bit of water". His example was Michigan, where a ballot initiative handed electoral boundaries to a commission of randomly drawn citizens.[^michigan]

## Where does power actually sit?

An audience member pressed on urgency, pointing to the AfD in Germany and One Nation at home. The answers showed the night's one real disagreement:
