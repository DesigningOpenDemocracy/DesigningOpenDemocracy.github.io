...
> "One way is having elections… There's now the problem is we purchase that legitimacy at the expense of equality of speech. There is a certain kind of person who overwhelmingly wins that contest. The alternative we have in our courts of law."
> — Nicholas Gruen
...
> "We're every bit as much of the problem of politics as the politicians are. And a lot of activism, a lot of people saying they're going to fix democracy, are suckers for a view that we're the good guys and the politicians are the bad guys. We're all part of a system, and the politicians don't act the way they do because they're bad people. They act the way they do because we reward them for acting in that way."
> — Nicholas Gruen
...
He describes the documented arc: jurors get a letter, feel a flicker of excitement, then dread ("oh god, this is politics… everyone's going to yell at me"), then walk into the room and find ordinary people much like themselves — and get deeply into the work. Around 90–95% report the experience as good; about half describe it as life-changing. He invokes Aristotle: democracy is a system in which people take turns governing and being governed — which, he notes, is *not* the system we have.
...
A subtle but important point he makes on accountability: a juror is *not* accountable by reporting back and justifying their vote — "the accountability to the people is being *of* the people, not in reporting back *to* the people." The legitimacy comes from the random sample being genuinely representative, not from a justification mechanism that, like transparency, can be gamed.

## Where it's already happening

Gruen surveys the real record. Roughly 14 citizens' juries in Australia, most successful; the South Australian nuclear-waste jury didn't give the government the answer it wanted but did surface the considered opinion of the people. Governments tend to commission them only on "tame" issues they can safely implement — which is exactly why he wants an *independent* standing assembly that can take on the contagious ones. Abroad: **Oregon's** Citizens' Initiative Review (24 randomly selected jurors, four days, 300 words for and against printed on the ballot); a permanent randomly selected citizens' council in the **German-speaking community of Belgium**, functioning rather like the Athenian Boule (Gruen's own description on the recording, "two provinces" and "I think it's of 50 people", is loose; the body is the Ostbelgien Citizens' Council of Belgium's German-speaking Community); **Madrid**; and the large national climate assemblies in **France** and the **UK**.

## Why a jury is hard to troll

Gruen places all this against the online information environment, citing Peter Pomerantsev's *This Is Not Propaganda*: trolls "undermine people's ability to know what's real and what's not real, and who's saying what and why." A citizens' jury, he argues, is structurally resistant to that: "You know who these people are, they're on the electoral rolls", and if someone turns up with a conspiracy theory, "the group can say, let's get some research done on that."

## A neutral process, not a campaign

Gruen wants the standing assembly run "as a form of activism. So it's not a pilot project or a demonstration project." But he draws a sharp line between that and cause-driven activism. When Brian mentions climate groups such as Coalition of Everyone, Gruen notes that "most people who are working in this area are activists themselves, and they're trying to bring about a particular result… that's not what I'm talking about… Setting this body up is not setting it up to come to any conclusion." His test case is Brexit: he was "strongly anti-Brexit", as were the donors who funded his attempt at Brexit citizens' juries, yet if a jury "represented the considered opinion of the British people, I'd think good on them."
...
- [Citizens' Democracy: Gruen and Hofkirchner (2017)](2017-10-21-podcast.md) — Gruen's earlier DOD presentation of the same argument
- [Lateral Economics](../../organisations/lateral-economics.md) · [newDemocracy Foundation](../../organisations/newdemocracy.md)

## Detailed notes

A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2020-03-03_isegoria-nicholas-gruen.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
