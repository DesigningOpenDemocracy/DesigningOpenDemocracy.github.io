...
link: https://www.meetup.com/DesigningOpenDemocracy/events/243645818/
...
![dodcitizendemocracy2017|353x500](2017-08-21_citizensDemocracy.jpg)
...
This event (York Butter Factory, 21 October 2017) paired two thinkers who agree on what's wrong with electoral democracy but propose different cures. It's worth reading alongside Gruen's later, more developed [2020 Isegoria talk](2020-03-20-podcast.md) — much of what he argues here is the seed of that one.
...
This is the event where Gruen's much-quoted line was recorded. In the Q&A, after agreeing that a citizens' chamber would reveal what the people want, he adds the catch:

> "But remember that in political combat, in our system, the considered opinion of the people amounts to nothing unless people respect it and pay it legitimacy. Because in political battle, you'll have all the press and all the soundbites and all the rest of it."
> — Nicholas Gruen

The wording above has been checked against the recording (Q&A episode, 00:49:44). The live meeting notes (below) have the ending as "unless you consider it properly"; those were written down by ear during the talk, and the recording's version also fits what he says next — that his whole project is building the legitimacy of what he calls "slow democracy", so people would say of jurors, "those people, they're just like me, they thought about it a lot more than I have." That sentence is the one later cited in DOD's [Taiwan analysis](2026-05-25-taiwan-digital-democracy.md) and philosophy notes — and it originates here.

**Hubertus Hofkirchner — Prediki and the G!LT party.** Hofkirchner, an Austrian investment banker turned entrepreneur, approaches the same problem from collective-intelligence engineering. He invokes Michels' *iron law of oligarchy* — every organisation eventually serves the people running it rather than its founding mission — and warns that the next generation of strongmen to rise that way would, unlike the 1930s, have atom bombs. His platform, **Prediki**, makes participants *place a bet* (in virtual currency) on outcomes before stating an opinion — which, he argues, switches people from posturing into genuine forecasting — and then uses sentiment analysis to dissect the arguments. Drawing on Tetlock's *Superforecasting* (foxes beat hedgehogs), the aim is to find the people genuinely good at judging a given question and let them specialise, increasing the system's "political bandwidth." His memorable refrain: *"Let's face it, nobody is interested in democracy, funnily enough, everybody assumes that it works."* He also cites the post-Brexit spike in Britons googling "what is the EU?"

One detail of his design is easy to miss: G!LT's citizen parliaments weren't pure sortition. Volunteers were first ranked by how well they had *predicted* outcomes on Prediki, and only then drawn by lot — half women, half men, across incomes — from the better forecasters. He argued that screens out people who "think all kinds of crazy things will happen, which of course never do happen". It's a real departure from the random-sample juries Gruen describes, and the Q&A never quite puts the two side by side.
...
The hour of questions (fully transcribed below) circles the practical objections DOD keeps returning to: how you introduce the idea publicly; how you select a jury that's genuinely representative; how you make it corruption-resistant (Gruen's answer: scrutineers and a transparent, inspectable selection process, plus the fact that randomly selected jurors have no standing incentive to favour an interest); how you hold jury representatives accountable; and whether such a chamber should sit alongside or replace the Senate. Gruen also distinguishes his approach from Iain Walker's [newDemocracy Foundation](../../organisations/newdemocracy.md): he wants citizens' juries as a form of *political activism*, not only as a tool governments commission for specific, safely tame problems. "You're the good cop, I'm the bad cop," he recalls telling newDemocracy's founder Luca Belgiorno-Nettis.

## Gruen's chamber, in detail

Asked whether his citizens' chamber would replace the Senate, Gruen sketched its powers more concretely than in any of his later DOD appearances:

- It would sit **in addition to** the Senate ("I'm quite relaxed about that"), as "some kind of citizen oversight of the Parliament".
- It would govern its own procedure by simple majority, and might get a **three-month delaying power** — less than the House of Lords' one year.
- Its real teeth would come with a **60–65% majority**: the power to **compel a secret ballot of the other chamber**. Of the 2014 carbon-price repeal he says "there would have been plenty of defectors if they knew they were safe in not being detected."
- Modest majorities of a small panel wouldn't count for much: no jurisdiction, he notes, treats less than 9 of 12 as a verdict.

His model for how a sampled body can move a vote is Oregon's **Citizens' Initiative Review**: 24 randomly selected citizens deliberate on each ballot initiative and publish a short statement for and against. On a mandatory-sentencing measure that roughly 70% of Oregonians initially backed, 21 of the 24 panellists signed the case against — and, in his telling, support fell to "56 or 7" per cent. (His figures; worth checking before repeating.) "I'm after plonking this damn thing there and saying, look at that, that works better than you guys."

## A note on the date

When DOD's archive was imported into this site in December 2023, this post was filed under 21 August 2017 — possibly when the event was first announced, though nothing now records why. The event itself was on Saturday 21 October 2017: that is the date on the [Meetup event page](https://www.meetup.com/DesigningOpenDemocracy/events/243645818/), all three recordings give it, and Hofkirchner reports the result of the Austrian election held six days earlier. The post was moved to 21 October in September 2026; its old address redirects here.

## Detailed notes

A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2017-10-21_citizens-democracy.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
...
- [Isegoria: how citizens' juries deliver it (2020)](2020-03-20-podcast.md) — Gruen's developed version of this talk
