...
> ones. The speaker biographies are preserved at the foot of the post. Quotes follow
> the automated transcript (fillers dropped, `…` marks cuts) — verify against the
> recording before citing.*

## Co-ops 101: democracy as an economic structure, not just a political one

Antony McMullen opens with the definition that sets up the whole talk. In the International Co-operative Alliance's wording, a cooperative is an autonomous association of persons united voluntarily to meet their common economic, social and cultural needs and aspirations through a jointly-owned and democratically-controlled enterprise; in McMullen's own, "It's an autonomous association. It should be doing what its members feel is the best thing for them to do." Strip away the jargon and it's **a democratically owned and controlled business** — and that ownership structure, he argues, is where economic democracy actually lives, distinct from the political kind:
...
On scale, he points to the **Evergreen Cooperatives** in Cleveland (solar, urban-farming greenhouses, an industrial laundry — all employee-owned and explicitly built as local economic development) and to **Mondragon** in the Basque Country: by McMullen's figures, "about 70,000 employees" and "the seventh largest" group in Spain (Mondragon itself reported closer to 80,000 workers around this time, and rankings of Spanish business groups vary), built up from nothing after the Spanish Civil War, starting with *education* before there was even a product.
...
Sean Bezard, from [Earthworker Cooperative](../../organisations/earthworker-cooperative.md), grounds the abstractions in how one cooperative actually runs. **Red Gum Cleaning Co-op** (started February 2018, "got gangbusters", 50+ regular clients; McMullen added that it won the Employee Ownership Australia Small to Medium Enterprise Award in 2018) has a board of five worker-member directors plus two non-member directors who bring outside expertise — Bezard, representing Earthworker, and a lawyer. Board positions (finance, secretary, union delegate) rotate among members so everyone gets governance experience, and the cooperative deliberately invests in members understanding its own finances.
...
- **Non-member directors** must always be a minority on the board — they bring expertise (law, finance, marketing) and can vote, but member-directors retain majority control. As Bezard puts it, his position on the board is not "to contradict, it's just to bring the expertise and kind of go with whatever the membership thinks is the best decision."
...
A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2020-03-27_beyond-csr-economic-democracy.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
