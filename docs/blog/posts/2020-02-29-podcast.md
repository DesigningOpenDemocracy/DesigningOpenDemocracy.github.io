...
That is Ben's claim on behalf of the party; no independent audit was cited in the conversation. It makes an instructive contrast with DOD's [2019 Trust episode](2019-12-11-podcast.md), recorded two months earlier, where guest Andrew Kay took the opposite line: "I'm a fan of trust, but verify any system that asks me to trust something, better have some very convincing testing functions that let me test that my trust is well placed" — and internet-based voting was, for him, "the worst thing I can think of."
