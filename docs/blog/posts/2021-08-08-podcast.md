...
This interview was recorded on 31 July 2021, the day after Austin attended a DOD session with Hubertus Hofkirchner (co-presenter at the 2017 [Citizens' Democracy event](2017-10-21-podcast.md)). Write In Stone sits at the intersection of journalism and democratic accountability — the premise being that you can't have informed public participation without trustworthy information.

Austin's background: philosophy at Macquarie University → freelance journalism → Beirut during the 2006 war (blog picked up by the Canberra Times) → Cairo during and after the Arab Spring → founding the company in 2017, which "only just now, nearly four years later" had a product almost ready for commercial use.
...
> "If your evidence trail and your good faith efforts are visible, then that protects you from attacks in the sense of attacks on your character… And if your process of creating original work is visible, that protects you from people disputing your ownership of the finished product."
> — Austin
...
> "We're actually the anti Twitter and we're not against Twitter. They've got a place in the ecosystem… When you want to be, you know, fast and flippant and fun, you go to Twitter. And when you want to take your time and get it right, you use Stone."
> — Austin
...
- [Citizens' Democracy: Gruen and Hofkirchner (2017)](2017-10-21-podcast.md) — Hofkirchner's earlier DOD talk; the 2021 session Austin attended the day before this interview was a separate, later one

## Detailed notes

A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2021-07-31_write-in-stone-austin.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
