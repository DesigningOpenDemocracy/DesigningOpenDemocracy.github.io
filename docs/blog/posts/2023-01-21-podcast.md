...
Jose Ramos opened with a framing that shaped the rest of the conversation. The left-right axis, he said, has "some truth in there, but it obscures a lot":

> "So the truth for me is that we have a billionaire problem. We got way too many billionaires… I'm a socialist… So you know where I sit on the spectrum."
> — Jose Ramos

His position is explicit, and it isn't a both-sides one. On economics, he argues, the left-right frame "makes sense": "there is a side that is squarely for equity and for greater equivocality, for greater participation. And I don't think you can argue against that." Where it breaks down is on other lines; his example is that Labor in Australia was historically anti-immigration. The post's own gloss: the same concentration he describes is what lets one owner's decision reshape a platform millions depend on, as Twitter's did that year. Cooperatives — democratically owned and controlled — are one structural response: the ownership question is answered before it becomes a crisis.
...
**Bridgette Engeler** — *post-growth innovation and better questions*. A professional futurist who says she "now torment[s] mostly MBA students at Swinburne University". Her honest position is a long one: worrying about her kids' world in 30 years ("I think it's about as good as it's gonna get for them right now"), what gets her out of bed is that "helping people ask better questions might help shape a better world in 150 years." Her concern is what we do when growth-as-default has to stop — not because anyone chose to stop it, but because complex adaptive systems don't accommodate infinite growth indefinitely. Foresight means sitting with uncertainty rather than manufacturing false certainty.
...
**Basil Varghese** — *affirmation of young talent*. After five decades in social justice movements (Vietnam, Black rights, anti-apartheid, now Indigenous Voice to Parliament), Basil's self-described role has shifted from activist to patron: "My role is to affirm and support young talent."
...
The panel didn't set these out as a list, but the cooperative model has specific design properties relevant to this (this summary's gloss, not the speakers'):
...
The tech-bros frame of the event title wasn't just polemic, on this post's reading. The collapse of centralised platforms creates a genuine opening for federated and cooperative alternatives — not because cooperatives are new, but because the failure mode of the incumbent model is now visible in real time.
...
> "AI reflects the cesspool of human thinking on the internet. It's going to regurgitate some combination of something between Putin, Trump and the Kardashians. You know what I mean? And that's why it's so damn intelligent."
> — Jose Ramos
...
> "We can simply enable us humans kind of bounce information amongst each other, and tap into our collective intelligence. But we're not doing because I think it doesn't translate into share and assets and things like that. I think that is a problem, but it's 100% feasible."
> — Alexar Pendashteh
...
A fuller, timestamped breakdown of this recording — who said what, transcription corrections, and claims worth checking before repeating them — is kept in the site's repository next to the transcripts: [analysis notes](https://github.com/DesigningOpenDemocracy/DesigningOpenDemocracy.github.io/blob/main/.podcast_transcript/analysis/2022-12-06_basils-table-tech-bros.md). Speaker labels there are inferred from the automated transcript, not checked against the audio.
