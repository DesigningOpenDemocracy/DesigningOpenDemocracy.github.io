...
summary: "A Taiwanese open consultation platform that uses structured online deliberation — via Pol.is — to develop policy positions on contested issues, with outputs fed directly into the legislative process."
location:
  latitude: 25.0330
  longitude: 121.5654
  name: Taipei, Taiwan
...
4. **Output** — a summary of areas of consensus and remaining disagreement, passed to the relevant ministry for decision
