---
title: Labsus — Laboratorio per la Sussidiarietà
type: ngo
status: active
country: IT
...
The organisation runs a university-accredited higher education course in shared administration (enrolling for 2026–2027), publishes a journal and research papers, and held the second edition of its Festival of Shared Administration in Assisi in March 2026. Labsus occupies an unusual space: neither a civic-tech platform nor a deliberative practitioners' network, but a legal-institutional innovation organisation — one that changed the law and the administrative practice, not just the conversation.

## Links

- Website: [labsus.org](https://www.labsus.org)
